...
@JsonTypeName(GetExistingClassesForApiRequest.CHANNEL)
public record GetExistingClassesForApiRequest(@JsonProperty("projectId") @Nonnull ProjectId projectId,
                                              ...
                                              @JsonProperty("deprecatedEntitiesTreatment") DeprecatedEntitiesTreatment deprecatedEntitiesTreatment) implements Request<GetExistingClassesForApiResponse> {
